...
# Purely additive section: reads reports/detection_summary_by_region.json
# (generated by src/geospatial/auto_triage_regions.py) and shows real-world
# detection counts per neighborhood as cards + a chart. Does not touch any
# other section — if the file doesn't exist yet, this just shows a hint.
...
with st.expander("🌍 Field Detections by Region (real-world tiles)", expanded=True):
